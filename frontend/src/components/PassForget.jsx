...
const PassForget = () => {
  ...
  return (
    <div>
      ...
      >
        <div className="bg-smbg bg-center bg-cover bg-[#F4FBFA] w-[100%] h-[100%] fixed xs1:hidden xs2:block  z-[-1] blur-[1.5px] opacity-[0.6]   "></div>
        <div className="xs1:w-[100%] xs2:w-[55%] xs3:w-[45%] xs4:w-[33%] xs1:h-[100%] xs2:h-[55%] xs3:h-[50%] xs4:h-[85%] p-[1.5rem] bg-[#ffffffb9] shadow-dull xs2:rounded-[1rem] flex flex-col xs2:border-[2px] ">
